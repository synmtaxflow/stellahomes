    ...
    <div class="card border-0 shadow-sm mb-3" id="profile-section">
        <div class="card-body text-center py-4">
            ...
            <div class="position-relative d-inline-block mb-3">
                <img 
                    src="{{ $user->profile_picture ? url('storage/' . $user->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&size=120&background=1e3c72&color=fff' }}" 
                    alt="Profile Picture" 
            ...
            <form id="profilePictureForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3 text-center">
                        <img 
                            src="{{ $user->profile_picture ? url('storage/' . $user->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&size=200&background=1e3c72&color=fff' }}" 
                            alt="Preview" 
