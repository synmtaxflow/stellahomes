            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="#about" class="nav-item nav-link">about stella homes</a>
    ...
    <div class="container-fluid bg-warning bg-opacity-10 py-5">
        <div class="container">
            ...
            <div class="alert alert-info mb-4">
                <h6 class="mb-2"><i class="bi bi-bank me-2"></i>Payment Account Details:</h6>
                <p class="mb-1"><strong>Account Number:</strong> {{ $ownerDetail->account_number }}</p>
                <p class="mb-1"><strong>Bank:</strong> {{ $ownerDetail->bank_name }}</p>
                <p class="mb-0"><strong>Account Name:</strong> {{ $ownerDetail->account_name }}</p>
            </div>
            @endif
                        ...
                        if (response.success) {
                            ...
                            let successContent = `
                                ...
                                <div class="alert alert-info">
                                    <p class="mb-2"><strong>Control Number:</strong> ${bookingInfo.control_number}</p>
                                    <p class="mb-2"><strong>Room:</strong> ${bookingInfo.room}${bookingInfo.bed ? ' - Bed: ' + bookingInfo.bed : ''}</p>
                                    <p class="mb-2"><strong>Username:</strong> ${bookingInfo.username}</p>
