...
Route::get('/api/blocks/{block}/rooms', [LandingPageController::class, 'getRoomsByBlock'])->name('landing.blocks.rooms');
Route::get('/api/rooms/{room}/beds', [LandingPageController::class, 'getBedsByRoom'])->name('landing.rooms.beds');
